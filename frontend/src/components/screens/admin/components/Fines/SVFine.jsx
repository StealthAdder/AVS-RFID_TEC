...
const SVFine = ({ svFineData }) => {
  console.log(svFineData);
  ...
  const [fineAmount, setFineAmount] = useState(svFineData.fineAmount);
  const [violationType, setViolationType] = useState(svFineData.violationType);
  ...
  return (
    <div>
      <Typography
        ...
        gutterBottom
      >
        Update Speeding Violation Fine
      </Typography>
